...
class Snippet_Library {
	 ...
	 *
	 * @param string $title The snippet title to find and install.
	 * @return int The created post ID.
	 *
	 * @throws \InvalidArgumentException If the snippet title is not found.
	 * @throws \RuntimeException        If the post could not be created.
	 */
	public function install_snippet( string $title ): int {
		$snippet = null;
